...
config.logo_text = "Runic Gaming | SCPRP"
...
config.messages_list = [
	"Welcome to Runic Gaming!",
	"Do !discord and !workshop in-game to get the server links!",
	"Need an admin? Press tab, then request staff!",
